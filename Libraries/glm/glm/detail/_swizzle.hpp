...
//
#define GLM_SWIZZLE_VECTOR_BINARY_OPERATOR_Impl(OPERAND)                 \
...
//
#define GLM_SWIZZLE_SCALAR_BINARY_OPERATOR_Impl(OPERAND)								\
	GLM_SWIZZLE_TEMPLATE1																		\
...
namespace glm
{
	namespace detail
	{
		GLM_SWIZZLE_SCALAR_BINARY_OPERATOR_Impl(-)
		GLM_SWIZZLE_SCALAR_BINARY_OPERATOR_Impl(*)
		GLM_SWIZZLE_VECTOR_BINARY_OPERATOR_Impl(+)
		GLM_SWIZZLE_VECTOR_BINARY_OPERATOR_Impl(-)
		GLM_SWIZZLE_VECTOR_BINARY_OPERATOR_Impl(*)
		GLM_SWIZZLE_VECTOR_BINARY_OPERATOR_Impl(/)
	}
